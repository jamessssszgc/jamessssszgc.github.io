                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p>Designed class interfaces with Singleton and Factory Design Pattern and implemented automation test suite framework for new and existing features. Developed an automated database migration test in MySQL to detect and fix data inconsistency. Maintained and configured Jenkins and web services such as Apache Tomcat, Apache James on Linux to support the R&D and QA team. Participated in an Agile development (Scrum) team, improved the user interface using Java Spring framework and merged mobile web pages into Responsive Designed Front End Pages in jsp.</p>
                      </div>
                    </div>
                  </article>
                  {/*
